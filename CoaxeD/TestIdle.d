...
class TestIdle : VBox
{
	...
	class TestDrawing : DrawingArea
	{
		...
		public void onMap(Widget widget)
		{
			debug(trace)
			{
				version(Tango) Stdout("idle.onMap").newline;
		...
		public void onUnmap(Widget widget)
		{
			debug(trace)
			{
				version(Tango) Stdout("idle.onUnmap").newline;
		...
		void onCallTypeChanged(ComboBoxText comboBoxText)
		{
			debug(trace)
			{
				version(Tango) Stdout.format("gcOptions = {}", comboBoxText.getActiveText()).newline;
