...
//	}
	...
	this()
	{
		...
		debug(trace)
		{
			version(Tango) Stdout("TestTreeView1.this 1").newline;
			else writefln("TestTreeView1.this 1");
		}
		super(false, 0);
		debug(trace)
		{
			version(Tango) Stdout("TestTreeView1.this 2").newline;
			else writefln("TestTreeView1.this 2");
		}
		pixbuf = new Pixbuf(greenClass_xpm);
		debug(trace) 
		{
			version(Tango) Stdout("TestTreeView1.this 2.1").newline;
			else writefln("TestTreeView1.this 2.1");
		}
		pixbufTest = new Pixbuf(book_closed_xpm);
		debug(trace) 
		{
			version(Tango) Stdout("TestTreeView1.this 2.2").newline;
		...
		debug(trace) 
		{
			version(Tango) Stdout("TestTreeView1.this 3").newline;
		...
		debug(trace) 
		{
			version(Tango) Stdout("TestTreeView1.this 4").newline;
		...
		debug(trace)
		{
			version(Tango) Stdout("TestTreeView1.this 5").newline;
		...
		debug(trace)
		{
			version(Tango) Stdout("TestTreeView1.this 6").newline;
	...
	bool moveCursorCallback(GtkMovementStep step, int i, TreeView tree)
	{
		...
		debug(trace)
		{
			version(Tango) Stdout("cursor on {}", v).newline;
